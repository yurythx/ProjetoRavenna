        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full" style={{ background: 'var(--accent)', color: 'white' }}>
              ...
              <span className="text-sm font-medium">{t('forgotRecuperar')}</span>
            </div>
            <h1 className="text-3xl font-bold mt-4">{t('forgotTitle')}</h1>
          ...
          <div className="card p-6">
            {sent ? (
              ...
              >
                ...
                <button className="btn btn-primary w-full h-12 text-base">{t('forgotSend')}</button>
              </form>
            )}
          </div>
        </div>
